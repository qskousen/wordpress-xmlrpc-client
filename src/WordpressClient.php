...
class WordpressClient
{
	...
	function getPost($postId, array $fields = array())
	{
		if (empty($fields))
		{
			$params = array($this->_blogId, $this->_username, $this->_password, $postId);
		}
		else
		{
			$params = array($this->_blogId, $this->_username, $this->_password, $postId, $fields);
		}
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $filters);
		if (!empty($fields))
		{
			$params[] = $fields;
		}
	...
	function newPost($title, $body, array $content = array())
	{
		...
		$params = array($this->_blogId, $this->_username, $this->_password, $content);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $postId, $content);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $postTypeName, $fields);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $filter, $fields);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $taxonomy);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $taxonomy, $termId);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $taxonomy, $filter);
	...
	function editTerm($termId, $taxonomy, array $content = array())
	{
		...
		$params              = array($this->_blogId, $this->_username, $this->_password, $termId, $content);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $itemId);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $filter);
	...
	function uploadFile($name, $mime, $bits, $overwrite = null, $postId = null)
	{
		...
		$params = array($this->_blogId, $this->_username, $this->_password, $struct);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $commentId);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $post_id, $comment);
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $commentId, $comment);
	...
	function getOptions(array $options = array())
	{
		...
		{
			$params = array($this->_blogId, $this->_username, $this->_password, $options);
		}
	...
	{
		$params = array($this->_blogId, $this->_username, $this->_password, $userId);
		if (!empty($fields))
		{
			$params[] = $fields;
		}
